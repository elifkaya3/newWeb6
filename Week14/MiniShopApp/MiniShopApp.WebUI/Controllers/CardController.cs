...
namespace MiniShopApp.WebUI.Controllers
{
    ...
    public class CardController : Controller
    {
        ...
        {
            //user bilgisinden yararlanarak userID bulalım.
            //userId,productId,quantity bilgilerini kullanıp bize carda ürün 
            //ekleme işlemini yapıp dönecek bir metot hazırlayalım
