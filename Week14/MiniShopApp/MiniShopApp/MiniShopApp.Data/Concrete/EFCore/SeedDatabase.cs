...
namespace MiniShopApp.Data.Concrete.EFCore
{
    public static class SeedDatabase
    {
        ...
        private static Product[] Products =
        {
            ...
            new Product() {Name="Xaomi Redmi 9 Pro", Price=15000, Description="Bu Telefon çok iyi bir telefon.",Url="xaomi-redmi-9-pro", IsApproved=true, IsHome=true},
            new Product() {Name="Xaomi Redmi 10 Pro", Price=10000, Description="Bu Telefon çok iyi bir telefon.",Url="xaomi-redmi-10-pro", IsApproved=true, IsHome=true},
            new Product() {Name="Xaomi Redmi 11 Pro", Price=11000, Description="Bu Telefon çok iyi bir telefon.",Url="xaomi-redmi-11-pro", IsApproved=true, IsHome=true},
