...
namespace EFCore_Kutuphane_03.Models
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitaplar>(entity =>
            {
                entity.HasKey(e => e.Isbn)
                    .HasName("PK__Kitaplar__447D36EB168B26A3");
            ...
            modelBuilder.Entity<Turler>(entity =>
            {
                ...
                entity.HasIndex(e => e.TurAd, "UQ__Turler__A1D0193D3D290697")
                    .IsUnique();
            ...
            modelBuilder.Entity<Yayinevleri>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ad, "UQ__Yayinevl__3214AD007CE4B184")
                    .IsUnique();
